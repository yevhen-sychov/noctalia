...
Set `custom_schedule = true` to drive day and night from `sunset`/`sunrise` instead — useful if you want night light and a dark theme on a fixed routine rather than on the actual sun.
